                        ...
                        <div class="card border-grey border-lighten-3 px-1 py-1 m-0">
                            ...
                            <div class="card-content">
                                ...
                                <div class="card-body">
                                    <form class="form-horizontal" action="<?= base_url('auth/login') ?>" method="post"
                                        ...
                                        <fieldset class="form-group position-relative has-icon-left">
                                            <input type="text" class="form-control round" id="user-name" name="username"
                                ...
                                <div class="d-flex justify-content-center">
                                    <p class="card-subtitle text-muted text-right font-small-3 mx-2 my-1"><span>Don't have an account ?</span></p>
                                </div>
                                <div class="d-flex justify-content-between">
                                    <a href="<?php echo base_url('register_dosen') ?>">Register Dosen</a>
                                    <a href="<?php echo base_url('register_mahasiswa') ?>">Register Mahasiswa</a>
