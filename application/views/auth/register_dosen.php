...
<head>
    ...
    <link href="../../../../../../fonts.googleapis.com/css93c2.css?family=Muli:300,300i,400,400i,600,600i,700,700i%7CComfortaa:300,400,700"
          rel="stylesheet">
                ...
                <div class="col-12 d-flex align-items-center justify-content-center">
                    <div class="col-lg-4 col-md-6 col-10 box-shadow-2 p-0">
                            ...
                            <div class="card-content">
                                ...
                                <div class="card-body">
                                    <form class="form-horizontal" method="post"
                                          action="<?= base_url('auth/registerDosen') ?>" novalidate>
                                        <?php
                                        if ($this->session->flashdata('alert') === 'errorregister'):
                                            ?>
                                            <div class="alert alert-warning mb-2" role="alert">
                                                <strong>Warning!</strong> Nip sudah terdaftar.
                                            </div>
                                        <?php endif; ?>

                                        <fieldset class="form-group position-relative has-icon-left">
                                            <input type="text" class="form-control round" id="nama-dosen"
                                                   placeholder="Masukkan Nama" required name="nama_pengguna"
                                                   autocomplete="off">
                                        ...
                                        <fieldset class="form-group position-relative has-icon-left">
                                            <input type="text" class="form-control round" id="nip_dosen"
                                                   placeholder="Masukkan Nip" readonly name="username_pengguna">
                                            <div class="form-control-position">
                                                <i class="ft-user"></i>
                                            </div>
                                        </fieldset>
                                        <fieldset class="form-group position-relative has-icon-left">
                                            <input type="password" class="form-control round" id="user-password"
                                                   placeholder="Masukkan Password" required name="password_pengguna">
                                            <div class="form-control-position">
                                                <i class="ft-lock"></i>
                                            </div>
                                        </fieldset>
                        ...
                        <span>Already a member ?
                            <a href="<?php echo base_url('login') ?>" class="card-link">Sign in</a>
                        </span>
                                    </p>
                                </div>
                            </div>
