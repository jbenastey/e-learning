                                    ...
                                    <form class="form-horizontal"method="post" action="<?=base_url('auth/insertMahasiswa')?>" novalidate>
                                        ...
                                        if ($this->session->flashdata('alert') === 'errorregister'):
                                            ...
                                            <div class="alert alert-warning mb-2" role="alert">
                                                <strong>Warning!</strong> Nim sudah terdaftar.
                                            </div>
                                        <?php endif; ?>
                                        <fieldset class="form-group position-relative has-icon-left">
                                            <input type="text" class="form-control round" id="user-name" placeholder="Masukkan Nama" required name="nama_pengguna">
                                            <div class="form-control-position">
                                                <i class="ft-lock"></i>
                                            </div>
                                        </fieldset>
                                        <fieldset class="form-group position-relative has-icon-left">
                                            <input type="text" class="form-control round" id="user-nim" placeholder="Masukkan Nim" required name="username_pengguna">
                                            <div class="form-control-position">
                                                <i class="ft-user"></i>
                                            </div>
                                        </fieldset>
                                        <fieldset class="form-group position-relative has-icon-left">
                                            <input type="password" class="form-control round" id="user-password" placeholder="Masukkan Password" required name="password_pengguna">
                                            <div class="form-control-position">
                                                <i class="ft-lock"></i>
                                            </div>
                                        </fieldset>
