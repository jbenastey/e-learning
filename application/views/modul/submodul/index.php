    ...
    <div class="col-12">
        <div class="card">
            <div class="card-header">
                <a class="btn btn-primary float-right btn-sm mt-5" href="<?= base_url() ?>modul/submodul/tambah/<?= $idModul ?>">Tambah</a>
                                                ...
                                                <td>
                                                    <div class="row">
                                                        <div class="col-md-3">
                                                            ...
                                                            <a href="<?= base_url('nilai/hasilDosen/' . $index['id_sub_modul']) ?> "
                                                               class="btn btn-primary bg-darken-4" title="Lihat Hasil">
                                                                <i class="ft-file"> </i>
                                                            </a>
                                                        </div>
                                                        <div class="col-md-3">
