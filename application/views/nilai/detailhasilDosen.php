...
<div class="card">
        <div class="card-body">
			...
			<button type="button" onclick="window.history.back()" class="btn btn-sm btn-outline-secondary float-left"
					style="position: absolute"><i
					class="ft-arrow-left"></i> Kembali Ke Modul</button>
